...
from src.schema.model import AccessTokenData, SNUserRegisteredResp, SNUserRegistrationReq, UserLoginReq
...
async def get_user_id(
    ...
    access_token_dict = await check_access_token(
        input_token=input_token_value, 
